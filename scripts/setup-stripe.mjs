...
try {
  ...
  // Stripe's list max is 100; adequate for this dedicated test account.
  ...
  // Reuses the first existing config — verify settings manually if one
  // pre-existed in this account.
